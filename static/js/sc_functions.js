...
sc.piLookup = (function(){
    ...
    function register(jsonData) {
        dataByName[jsonData.script] = jsonData.data;
    }
    ...
    function enablePaliLookup(){
        ...
        scriptUrl = 'data/pi2{}-maindata-v1.js'.format(script);
        
        function ready() {
            lookupData = dataByName[script];
